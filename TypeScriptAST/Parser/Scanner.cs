...
namespace Zu.TypeScript.TsParser
{
    ...
    public class Scanner
    {
        ...
        public static Dictionary<string, SyntaxKind> TextToToken = new()
        {
...
{ "@", SyntaxKind.AtToken },
        ...
        private static Regex _shebangTriviaRegex = new("/^#!.*/");
...
caseLabel2: pos++;
        ...
        public static U IterateCommentRanges<T, U>(
            bool reduce, string text, int pos, bool trailing, Func<(int pos, int end, CommentKind kind, bool hasTrailingNewLine, T state, U memo), U> cb, T state, U initial = default)
        {
            var pendingPos = 0;
            var pendingEnd = 0;
